...
#elif defined(CONFIG_CPU_FREQ_DEFAULT_GOV_INTELONDEMAND)
extern struct cpufreq_governor cpufreq_gov_intelondemand;
#define CPUFREQ_DEFAULT_GOVERNOR	(&cpufreq_gov_intelondemand)
#endif
